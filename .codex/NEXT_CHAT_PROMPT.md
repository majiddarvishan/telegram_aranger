...
Important: the YouTube feature is currently **planning-only**. Do not implement production code until I explicitly tell you to start implementation.
...
When I tell you to start implementation, begin from **YT-P1 — Service foundation**, work phase-by-phase, keep CI green, and update `.codex/TASKS.md` and `.codex/SESSION.md` after each meaningful step.
